...
`,
  ...
  keywords: [
    ...
    // Core Expertise (Primary ranking targets)
    "React developer",
    "Next.js developer",
    "Node.js developer",
    ...
    // AI specialization (high growth SEO area)
    "AI SaaS developer",
    "LLM integration",
    "RAG systems",
  ...
  dateCreated: "2021-07-01", // YYYY-MM-DD
}
