...
export const TESTIMONIALS_1: Testimonial[] = [
  ...
  {
    authorAvatar: "https://unavatar.io/x/techlead",
    authorName: "Sofia Martinez",
    authorTagline: "Tech Lead | SaaS Platform",
    url: "#",
    quote:
      "Daniel brings a rare mix of strong system design skills and product awareness. He does not just write code — he builds solutions that actually move products forward.",
    date: "2026-03-22",
  },
  {
  ...
  {
    authorAvatar: "https://unavatar.io/x/cto",
    authorName: "Laura Kim",
    authorTagline: "CTO | AI SaaS Company",
    url: "#",
    quote:
      "Daniel consistently delivers clean, maintainable code and thinks ahead about scalability. He operates like a senior engineer who truly owns his work.",
    date: "2026-03-18",
  },
  {
